...
const BetbryCrash_1 = __importDefault(require("../../Models/BetbryCrash"));
const PadroesBetbryCrash_1 = __importDefault(require("../../Models/PadroesBetbryCrash"));
...
class BetbryCrashController {
    async BetbryCrash() {
        ...
        open();
        function open() {
            var SocketBetbryCrash = new Websocket('wss://aws3.rescdns.com/gs2/listen?module=jU86x7bq');
            SocketBetbryCrash.onopen = () => {
                ...
                setInterval(() => {
                    SocketBetbryCrash.send(JSON.stringify({ "data": "switch-module", "modules": ["jU86x7bq", "G-FO0ER0GS", "global"] }));
                }, 500);
            };
        ...
        async function crash(crashValue) {
            ...
            await Database_1.default.transaction(async (trx) => {
                const newSave = new BetbryCrash_1.default();
        ...
        Ws_2.default.io.on('connection', (SocketBetbryCrash2) => {
            ...
            SocketBetbryCrash2.on('qtJogosCrashBetbry', (data) => {
                ...
                async function getJogos(data) {
                    ...
                    let list = await BetbryCrash_1.default.query().orderBy('id', 'desc').limit(quantidadeJogos);
                    if (quantidadeJogos !== 100) {
                        list = await BetbryCrash_1.default.query().orderBy('id', 'desc').limit(quantidadeJogos);
                    }
            ...
            SocketBetbryCrash2.on('betbryCrashNewPadrao', (data) => {
                ...
                async function getNewPadrao(padrao, userId) {
                    await PadroesBetbryCrash_1.default.create({ padrao: padrao, user_id: userId });
                }
            });
            SocketBetbryCrash2.on('betbryCrashGetPadraoList', (data) => {
                ...
                async function putPadrao(userId) {
                    let listPadrao = await PadroesBetbryCrash_1.default.query().where('user_id', '=', userId);
            ...
            SocketBetbryCrash2.on('betbryCrashDeletePadrao', (data) => {
                ...
                async function deletePadrao(idPadrao) {
                    await PadroesBetbryCrash_1.default.query().where('id', '=', idPadrao).delete();
                }
            });
            SocketBetbryCrash2.on('PadroesShareBetbryCrash', (data) => {
                ...
                async function BetbryCrash(idPadrao, userId, name, casaDeAposta, casaDeApostaTipo) {
                    ...
                    let padraoBusca = await PadroesBetbryCrash_1.default.query().where('id', idPadraoBusca).first();
...
//# sourceMappingURL=BetbryCrashController.js.map